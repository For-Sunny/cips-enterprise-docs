...
CMM Enterprise is bundled with the CIPS Stack. See EULA for full terms including 90-day money-back guarantee.
...
Portions of the technology described herein are subject to pending patent application(s) filed with the United States Patent and Trademark Office. The methods, processes, and architectures embodied in this software -- including but not limited to unified heterogeneous memory search, multi-backend cognitive synthesis, and neural gate pre-retrieval boosting -- may be protected under one or more issued or pending patents.
