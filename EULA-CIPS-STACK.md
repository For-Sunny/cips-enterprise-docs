...
**The CIPS Stack (Complete Bundle)**
...
**"Software":** The CIPSCORPS LLC product bundle identified in the purchase confirmation, including **The CIPS Stack**, which comprises the following components:
- CASCADE Enterprise RAM + Docker
- PyTorch Memory Enterprise
- Hebbian Mind Enterprise
- Soul Matrix Rust
- CMM (Cognitive Memory Manager)

Together with all documentation, updates, and related materials provided by CIPSCORPS LLC.
...
### 2.1 Grant of Rights
Subject to the terms of this Agreement and full payment of applicable fees, CIPSCORPS LLC grants Customer a **non-exclusive, non-transferable, perpetual license** to install and use all components of the Software bundle.

### 2.2 Per-Developer Licensing Model

Each license purchased grants **ONE (1) named Developer** the right to install and use ALL components of the CIPS Stack on unlimited devices under their direct control. The number of licensed Developers must equal or exceed the number of individuals who install, access, or use any component of the Software within your Organization at any given time.

**How It Works:**
- Purchase 10 licenses = Assign to 10 named individuals (Bob, Alice, Carol, etc.)
- Each named individual can install ALL bundle components on multiple machines (laptop, desktop, servers)
...
**Examples:**
- Bob (licensed) installs all 5 components on laptop + desktop + home server = OK
- Alice (licensed) uses CASCADE and PyTorch from office, Hebbian from home = OK
- Bob (licensed) shares login with Dave (unlicensed) = VIOLATION
- 10 licenses but 12 people using any component = VIOLATION (need 12 licenses)

**Audit Compliance:**
Customer shall maintain a list of named licensed Developers. Upon audit request (Section 4), Customer must provide the names and roles of all individuals using any component of the Software.

**Pricing Structure:**
- **Base License:** Covers one (1) Developer for ALL components - **$1,500**
- **Additional Developers:** **$150** per additional Developer
- **Current Pricing:** See https://cipscorps.io/pricing
- **Bundle Savings:** 25% off individual component pricing

### 2.3 Bundle Components

The CIPS Stack includes perpetual licenses for:

| Component | Individual Price | Included |
|-----------|-----------------|----------|
| CASCADE Enterprise RAM + Docker | $400 | Yes |
| PyTorch Memory Enterprise | $600 | Yes |
| Hebbian Mind Enterprise | $800 | Yes |
| Soul Matrix Rust | Not sold separately | Yes |
| CMM (Cognitive Memory Manager) | Not sold separately | Yes |
| **Individual Total** | **$1,800** | |
| **Bundle Price** | **$1,500** | **Save $300** |

### 2.4 Permitted Uses
You MAY:
- Install all components of the Software on unlimited machines for each licensed Developer
...
- Use all components together as an integrated system or individually as needed

### 2.5 Prohibited Uses
You MAY NOT:
- Transfer, sublicense, rent, lease, or redistribute the Software or any component to any third party
- Offer the Software or any component as a service (SaaS) to external customers or end users
...
- Allow more Developers to use any component than licenses purchased
- Unbundle and resell individual components

### 2.6 License Scope Clarification
...
**Total License Fee:** $1,500 + (Number of Additional Developers x $150)

### 3.2 Adding Developers
Additional Developers may be added at any time by purchasing additional licenses at the then-current published per-Developer rate. Additional Developer licenses **must be purchased BEFORE** those Developers access or use any component of the Software.

### 3.3 Delivery
Upon payment confirmation, CIPSCORPS LLC will provide Customer with:
- Download links or access credentials for ALL components of the CIPS Stack
- License key or activation credentials (if applicable)
- Documentation and deployment guides for each component
- Integration guides for using components together
- Confirmation of licensed Developer count

### 3.4 Updates & Support
Customer is entitled to **all software updates, bug fixes, and patches for ALL components for one (1) year** from the Effective Date. After the one-year period:
- Customer may continue using the Software versions received indefinitely
...
- Total number of Developers using any component of the Software
...
- Total number of Developers currently using any component of the Software
...
- Systems and installations where any component of the Software is deployed
...
1. **Pay Deficiency:** Purchase additional licenses to cover all unlicensed Developers at **two times (2x)** the standard per-Developer rate
2. **Reimburse Audit Costs:** Pay CIPSCORPS LLC's reasonable costs incurred in conducting the audit
3. **Cure Breach:** Bring usage into compliance within thirty (30) days or face license termination
...
- Customer uses Software in violation of Section 2.5 (Prohibited Uses)
- Customer refuses to comply with audit requests under Section 4

### 6.3 Termination for Convenience by Customer
Customer may terminate this Agreement at any time by ceasing all use of the Software and deleting all copies of all components. **Termination does not entitle Customer to a refund** except as provided in Section 7 (Refund Policy).

### 6.4 Effects of Termination
Upon termination:
- Customer's license to use ALL components of the Software terminates immediately
- Customer must cease all use and delete all copies of all components within ten (10) days
...
CIPSCORPS LLC offers a **90-day money-back guarantee** on all commercial products including the CIPS Stack bundle. Customer may request a full refund of the purchase price within **ninety (90) days** of the Effective Date by emailing **glass@cipscorps.io** with subject line "Refund Request."
...
- This license terminates immediately and automatically for ALL components
- Customer must cease all use of ALL components within ten (10) days
- Customer must delete all copies of ALL components
...
CIPSCORPS LLC DISCLAIMS ALL WARRANTIES INCLUDING BUT NOT LIMITED TO:
...
- **Component Integration** - No guarantee all components will work together in all environments
...
**TO THE MAXIMUM EXTENT PERMITTED BY LAW**, CIPSCORPS LLC SHALL NOT BE LIABLE FOR:
...
CIPSCORPS LLC's total cumulative liability for **all claims** arising from or related to this Agreement or the Software, whether in contract, tort, or otherwise, shall not exceed the **total amount paid by Customer to CIPSCORPS LLC** for the CIPS Stack bundle giving rise to the claim.

### 9.3 Exceptions
The limitations in Sections 9.1 and 9.2 do **not** apply to:
- Customer's breach of Section 2.5 (Prohibited Uses), particularly unauthorized redistribution
...
**Software Licensed:** The CIPS Stack (Complete Bundle)
**Components Included:**
- CASCADE Enterprise RAM + Docker
- PyTorch Memory Enterprise
- Hebbian Mind Enterprise
...
**Base License Fee:** $1,500
**Per Additional Developer:** $150

**Electronically accepted via purchase confirmation**

---

**CIPSCORPS LLC Contact Information:**
C.I.P.S. LLC
1753 Bernard Dr
Elliston, VA 24087
Email: glass@cipscorps.io
Website: https://cipscorps.io

---

*EULA Version 1.0*
*Effective: January 26, 2026*
*Product: The CIPS Stack (Complete Bundle)*
