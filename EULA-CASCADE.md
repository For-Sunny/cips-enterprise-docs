...
**"Software":** The CIPSCORPS LLC product(s) identified in the purchase confirmation, including **CASCADE Enterprise RAM + Docker**, together with all documentation, updates, and related materials provided by CIPSCORPS LLC.
...
**Audit Compliance:**
Customer shall maintain a list of named licensed Developers. Upon audit request (Section 4), Customer must provide the names and roles of all individuals using the Software.

**Pricing Structure:**
- **Base License:** Covers one (1) Developer - **$400**
- **Additional Developers:** **$40** per additional Developer
...
**Total License Fee:** $400 + (Number of Additional Developers x $40)
...
### 5.1 Ownership
CIPSCORPS LLC retains all right, title, and interest in and to the Software, including all patents, copyrights, trademarks, trade secrets, and other intellectual property rights. This Agreement grants a license to **use**, not a transfer of **ownership**.

Certain methods and processes may be protected under pending patent applications.
...
**Software Licensed:** CASCADE Enterprise RAM + Docker
**Base License Fee:** $400
**Per Additional Developer:** $40
...
*Product: CASCADE Enterprise RAM + Docker*
